...
<html lang="en">
  <head>
    ...
    <title>Tax Manager | Déduction des frais médicaux</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Déduction des frais médicaux</h1></div>
                            <div class="services-wrap">
                                <p>En règle générale vous ne pouvez pas manquer la déduction du forfait de l’assurance maladie dans votre déclaration d’impôt, l’administration cantonale de contribution prendra en charge cette déduction même si vous ne la réclamez pas dans votre déclaration, toutefois le forfait déductible de votre assurance maladie dépond du canton résidence selon des critères bien précis.</p>
                                <p>Sachant que la totalité des frais médicaux ne sont pas remboursés par votre assurance maladie, vous pouvez cependant réclamer les frais médicaux à votre charge en suisse ou à l’étranger si la totalité des frais dépassent 5% du revenu net imposable, à noter que le canton du Valais accepte la déduction des frais médicaux s’ils dépassent 2% du revenu net imposable.</p>
