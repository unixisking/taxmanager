...
<html lang="en">
  <head>
    ...
    <title>Fiduciaire Tax Manager | Comptabilité et gestion des salaires</title>
	<meta name="description" content="Vous avez besoin d'un fiduciaire pour vous accompagner dans votre comptabilité et gestion salariale, bénéficiez d'une équipe de professionnels qui vous aident à digitaliser votre comptabilité."/>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Comptabilité</h1></div>
                            <div class="services-wrap">
                                <p>La comptabilité est un outil de gestion de données financières qui permet aux entreprises et organisations telles que les associations et les fondations d’avoir accès à des informations sur la situation financière de l’entreprise, à condition que la journalisation des opérations soit à jour.</p>
							    <p>Selon l'art. 957a CO, la comptabilité compose la base de l'établissement des comptes. Elle enregistre les flux résultant des opérations économiques de l'entreprise et les autres faits nécessaires à la présentation du patrimoine, de la situation financière et des résultats de l'entreprise.</p>
                                <p>Le travail comptable commence dès la réception, classement et enregistrement des pièces comptables, à cela il faut ajouter d’autre éléments essentiels au fonctionnement de l’entreprise ou de l’organisation tel que les amortissements des actifs immobilisés, décompte TVA et écritures transitoires.</p>
							    <p>Avec les nouveaux outils informatiques, il existe un nouveau <a href=" https://fiduly.ch/ " target="_blank"> logiciel comptable</a> basé uniquement sur le cloud qui a révolutionné la comptabilité. Vous pouvez désormais partager votre travail comptable avec votre fiduciaire sans aucun déplacement physique. </p>
