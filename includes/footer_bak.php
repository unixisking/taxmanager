        ...
        <footer id="tax-footer" class="tax-footer-one">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                            <div class="our-footer-info">
                                    ...
                                    <div class="our-footer-likns">
                                        <ul>
                                            <li><i class="fa fa-chevron-right"></i> <a href="declaration-d-impot-pour-les-particuliers.php">Déclaration d'impôt pour les particuliers</a></i>
            ...
            <div class="tax-copyright">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12" >
                            <p style="padding: 20px 0 20px"><i class="fa fa-copyright"></i> 2020, Tous les droits sont réservés - Développé par <a href="#" target="_blank">Didata</a></p>
                        </div>
                    </div>
                </div>
            </div>
