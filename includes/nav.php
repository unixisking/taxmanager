		...
		<header id="tax-header" class="tax-header-one">
		  <div class="tax-top-strip">
			<div class="container">
			  <div class="row">
				<div class="col-md-3">
				  <a href="https://www.taxmanager.ch" class="logo"><img src="images/fiduciaire-pully" alt="Logo Fiduciaire Tax Manager"></a>
				</div>
				<div class="col-md-9">
								  ...
								  <div class="col-md-10">
									<div class="row">
									  <div class="col-md-6">
										<div class="nav-mega">
										  <h2>
										  	<div class="fa icon-container"><img class="new-icons loading" data-src="images/tax_service.svg"></div> <a href="imposition-des-particuliers.php">Imposition des particuliers</a>
										  </h2>
										  <ul>
											<li><h3><a href="declaration-d-impot-ordinaire.php">Declaration d'impot ordinaire</a></h3></li>
