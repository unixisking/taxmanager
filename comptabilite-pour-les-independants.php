...
<html lang="fr">
  <head>
    ...
    <title>Fiduciaire Tax Manager | Comptabilité pour les indépendants</title>
	<meta name="description" content="En tant qu'indépendant, vous avez l'obligation de tenir une comptabilité complète si votre chiffre d'affaires dépasse 500'000 CHF. La Fiduciaire Tax Manager est là pour vous aider."/>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Comptabilité pour les indépendants (personnes physiques)</h1></div>
                            <div class="services-wrap">
                                <p>Pour les personnes physiques entre autres les indépendants propriétaire d’une raison individuelle ou une société en nom collectif dont le chiffre d’affaire ne dépassent pas 500’000 CHF n’ont pas l’obligation de tenir une comptabilité complète et peuvent se contenter d’une comptabilité simplifiée qui permets au contribuable de déclarer correctement son bénéfice ou perte imposable.</p>
                                <p><strong>Remarque:</strong> à noter que l’entreprise à l’obligation de conserver et pendant dix ans les différentes rapports et pièces comptables relatif à chaque exercice, sous certaines dispositions spéciales, la conservation des pièces justificatives peut être sauvegarder sous forme électronique ou autres formes équivalentes.  </p>
