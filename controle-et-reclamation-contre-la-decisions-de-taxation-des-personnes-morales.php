...
<html lang="fr">
  <head>
    ...
    <title>Fiduciaire Tax Manager | Contrôle et réclamation contre la décision de taxation des personnes morales</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Contrôle et réclamation contre la décision de taxation des personnes morales</h1></div>
                            <div class="services-wrap">
                                <p>Une décision de taxation n’est pas définitive pour une personne morale tel qu’une SA, Sàrl, Coopérative, la société ou son mandataire à le droit de s’opposer à la décision par écris sous un délai de 30 jours à compter de la notification de la décision.</p>
