...
<html lang="en">
  <head>
    ...
    <title>Tax Manager | The taxation of legal entities</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>The taxation of legal entities</h1></div>
                            <div class="services-wrap">
                                <p>According to the Swiss law, the word legal entity comprises limited liability companies, limited companies, cooperatives companies, partnerships limited by shares, and at last associations and foundations. </p>
                                <p>These legal entities are considered as tax subjects independent of their members and their administrative bodies, the taxation of legal entities is calculated on the basis of the profit and the capital of each fiscal year. However, two types of tax liability of legal entities are distinguished;</p>
