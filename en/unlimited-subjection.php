...
<html lang="en">
  <head>
    ...
    <title>Tax Manager | Unlimited liability</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Unlimited liability</h1></div>
                            <div class="services-wrap">
                                <p>Applies to companies which headquarters, or effective administration is registered in one of the Swiss cantons. In principle, they are taxable on the entire profit and capital for each fiscal year.</p>
