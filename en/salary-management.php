...
<html lang="en">
  <head>
    ...
    <title>Fiduciary Tax Manager | Salary management</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Salary management</h1></div>
                            <div class="services-wrap">
                                <p>The salary management within a company is not an easy task, particularly the calculation of the hourly, monthly, a thirteenth salary, daily sickness and accident indemnities, calculation of overtime ... This task could be extremely complicated if you do not use the right tool. For this reason, our fiduciary has made every effort to develop salary software in order to offer its corporate clients the best solution available on the Swiss market based solely on the cloud. We have combined all the previous experience gained by our employees in payroll management so that you can easily resolve complex situations in record time.</p>
