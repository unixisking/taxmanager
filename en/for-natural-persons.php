...
<html lang="en">
  <head>
    ...
    <title>Tax Manager | For natural persons (individuals)</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>For natural persons (individuals)</h1></div>
                            <div class="services-wrap">
                                <p>For natural persons (individuals), inter alia self-employed owners of a sole proprietorship or a general partnership whose turnover does not exceed CHF  500'000, are not required to keep complete accounts and can be satisfied with simplified accounting which allows the taxpayer to correctly report his taxable profit or loss.</p>
                                <p><strong>Note:</strong> it should be noted that the company has to keep for ten years the various reports and accounting documents related to each financial year, under certain special provisions, the storage of supporting documents may be saved in electronic or other equivalent form.  </p>
