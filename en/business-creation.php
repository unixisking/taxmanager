...
<html lang="en">
  <head>
    ...
    <title>Tax Manager | Business creation</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Business creation</h1></div>
                            <div class="services-wrap">
                                <p>The creation of a company is a project that requires a lot of preparation, a bad decision could have an impact on the future of the company. To succeed in the project of creating your business, it is necessary to proceed in stages.</p>
                                <p>Creating a business is a very important step for every entrepreneur. Before you start, it's important to plan your startup by choosing the right legal form for your industry, expenses and turnover.</p>
