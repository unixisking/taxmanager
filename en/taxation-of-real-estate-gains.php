...
<html lang="en">
  <head>
    ...
    <title>Tax Manager | Taxation of real estate gains</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Taxation of real estate gains</h1></div>
                            <div class="services-wrap img" style="margin: 0px;">
                                <p>The gain realized on the sale of real estate is taxable in all the cantons. In general, the cantons collect directly the tax due, which is due only by the seller and is also calculated according to the duration of possession of the property.</p>
                                <p>If the sale is reserved for the purchase of another property intended for habitation, the tax rate will be lower in this case.</p>
                            </div>
                            <div class="services-wrap-img"><img src="../images/tax-gain.jpg" alt=""></div>
