...
<html lang="en">
  <head>
    ...
    <title>Tax Manager | Control and claim against tax assessment</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Control and claim against tax assessment</h1></div>
                            <div class="services-wrap">
                                <p>A tax assessment is not final, the taxpayer or his agent has the right to object to the tax assessment in writing within 30 days of notification.</p>
                                <p>In some cases, and depending on the decision of tax authorities, the claim is essential, we advise our readers to call upon a study such as ours to assert your rights.</p>
