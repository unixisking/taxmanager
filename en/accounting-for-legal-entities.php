...
<html lang="en">
  <head>
    ...
    <title>Tax Manager | Accounting for legal entities</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Accounting for legal entities</h1></div>
                            <div class="services-wrap">
                                <p>According to the code of obligations, all legal entities such as limited liability companies, public limited companies, cooperatives, associations and foundations are required to keep complete accounts including a balance sheet, an operations log and an income statement.</p>
                                <p><strong>Note:</strong> It should be noted that the company has to keep for ten years the various reports and accounting documents for each financial year. In the context of certain special provisions, the retention of supporting documents may be saved in electronic form or in another equivalent form.</p>
