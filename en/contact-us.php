...
<html lang="en">
  <head>
    ...
    <title>Tax Manager | Contact Us</title>
        ...
        <div class="tax-main-content">
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
						  <h1 class="section-title">Our fiduciary at your service</h1>
                            <div class="fancy-title"><h2><i class="fa fa-handshake-o"></i> Get In Touch</h2></div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="tax-contact-info">
                                <ul>
                                    <li><strong><i class="fa fa-phone"></i> Phone:</strong> <a href="tel:+41 21 552 02 22">+41 21 552 02 22</a></li>
                                    <li><strong><i class="fa fa-envelope"></i> E-mail:</strong> <a href="mailto:info@taxmanager.ch">info@taxmanager.ch</a></li>
                                    <li><strong><i class="fa fa-globe"></i> Address:</strong> <span>Avenue de Tivoli 25 ,1007 Lausanne </span></li>
                                </ul>
                            </div>
                            <div class="map">
