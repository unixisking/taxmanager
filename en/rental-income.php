...
<html lang="en">
  <head>
    ...
    <title>Tax Manager | Rental income</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Rental income</h1></div>
                            <div class="services-wrap">
                                <p>For residents and owners of real estate in Switzerland, rental income is reported in their own tax return.</p>
                                <p>For persons holding property in Switzerland living abroad and according to Swiss law and cantonal practices, the owners of real estate are subject to rental income. This means that they must pay the tax on the rental income collected.</p>
                                <p>The cantons take into account a flat rate as rental income even if the property has not been rented or considered as a second home.</p>
