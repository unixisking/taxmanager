...
<html lang="en">
  <head>
    ...
    <title>Tax Manager | Dénonciation spontanée</title>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="tax-main-wrapper">
		...
		<!--// Main Banner \\-->
		<div class="subheader" style="background-image: url('images/spontaneous.jpg');">
        </div>
		<!--// Main Banner \\-->
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Dénonciation spontanée</h1></div>
                            <div class="services-wrap">
                                <p>Le contribuable (personne physique et morale) qui n’a pas déclaré la totalité de ses revenus ou ses actifs en suisse et à l’étranger, peut volontairement régulariser sa situation vis-à-vis des autorités fiscales en procédant à une dénonciation spontanée non punissable par la loi pour autant que l’autorité fiscale n’ait pas encore eu connaissance de ses revenus et actifs, l’autorité fiscale facture la différence d’impôt impayé avec des intérêts de retard. </p>
                                <p>Pour la dénonciation spontanée, le contribuable doit collaborer sans réserve avec les autorités fiscales et fournir tous les documents nécessaires afin de déterminer les éléments imposables des dix dernières années. </p>
                                <p>Dans le cas de la dénonciation spontanée aussi appelé l’autodénonciation, le contribuable échappe non seulement à une plainte pénale mais aussi à une amende allant de 1/3 à 3 fois de l’impôt soustrait, à noter que l’autodénonciation peut-être engagée qu’une seule fois et porte sur les dix dernières années précédant l’annonce.</p>
                                <p>Si le contribuable procède à une autodénonciation une seconde fois, il est passible d’une amende, d’un rappel d’impôt et d’intérêts de retard.</p>
                                <h3 class="section-title sub">En cas de succession:</h3>
                                <p>En cas d’héritage non déclaré par le défunt, les héritiers peuvent bénéficier d’un rappel d’impôt simplifié s’ils annoncent spontanément le revenu et la fortune non déclarés par le défunt, l’autorité fiscale notifie les suppléments d’impôts sur trois ans au lieu de dix.</p>
