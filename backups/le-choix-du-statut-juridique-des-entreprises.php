...
})(window,document,'script','dataLayer','GTM-5LF7LR5');</script>
<!-- End Google Tag Manager -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <title>Fiduciaire Tax Manager | Le choix du statut juridique des entreprises</title>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="tax-main-wrapper">
                        ...
                        <div class="col-md-9">
                            <ul class="ec-user-section">
                                ...
                                <li>
                                    ...
                                    <div class="lang">
                                        <a href="en/the-choice-of-the-legal-status-of-companies.php">English</a>
                                        <a href="le-choix-du-statut-juridique-des-entreprises.php" class="active">French</a>
                                    </div>
                                </li>
                                  ...
                                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6" style="padding-left: 50px;">
                                                                <div class="nav-mega">
                                                                    <h2><i class="fa fa-calculator"></i> <a href="comptabilite.php">Comptabilité et gestion des salaires</a></h2>
										  						    <ul>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li class="tax-side-dropdown"><i class="fa fa-angle-down"></i><a href="comptabilite.php">Comptabilité et gestion des salaires</a>
                                                            <ul class="service-drop">
                                                                ...
                                                                <li><a href="comptabilite-pour-les-personnes-morales.php">Comptabilité pour legestion des salaires</a></li>
                                                            </ul>
                                                        </li>
                                     ...
                                     <li class="nav-item">
										...
										<li class="nav-item">
										<a class="nav-link" href="actualites-et-articles.php">Actualiés et articles</a>
                                      </li>
                                    </ul>
                                  </div>
                                </nav>
		...
		<!--// Main Banner \\-->
		<div class="subheader" style="background-image: url('images/business-creation.jpg');">
        </div>
		<!--// Main Banner \\-->
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Le choix du statut juridique des entreprises</h1></div>
                            <div class="services-wrap">
                                <p>Le choix du statut juridique est un élément primordial dans la création ou l’évolution de l’entreprise. Comme nous l’avons expliqué sur notre site, vous avez le choix entre avoir une entreprise considérée en tant que personne physique ou morale. Les deux choix représentent des avantages et des inconvénients que nous avons évoqué.</p>
                                <h3 class="section-title sub">Qu'est-ce qu'une personne physique et morale ?</h3>
                                <h3 class="section-title sub">1.    Personne physique</h3>
                                <p>Afin que vous puissiez comprendre assez facilement la définition d’une personne physique, nous allons éviter les termes techniques et essayer de la simplifier au maximum. Une personne physique est une personne ayant un nom, prénom, adresse, date de naissance et une pièce d’identité comme vous, cher lecteur.</p>
                                <p>Selon le droit suisse, certains statuts juridiques d'entreprises sont considérés comme des personnes physiques, tels que ;</p>
                                <ul>
                                    <li>Raison individuelle</li>
                                    <li>Société en nom collectif</li>
                                    <li>Société en commandite simple</li>
                                </ul>
                                <h3 class="section-title sub">2.     Personne morale</h3>
                                <p>La personne morale est une entité détenant une personnalité juridique avec un nom et une adresse, elle doit être représentée au minimum par une personne physique. Le statut de personnalité juridique lui donne des droits et des obligations. Exemples : signature de contrat, achat, vente, progression, extension, développement, poursuivre et être poursuivi en justice, on distingue trois groupes principaux pour les personnes morales ;</p>
                                <ul>
                                    <li>Les sociétés de capitaux (sociétés à responsabilité limitée,</li>
                                    <li>Sociétés anonymes, sociétés en commandite par actions)</li>
                                    <li>Les sociétés coopératives</li>
                                    <li>Les autres personnes morales (associations et fondations)</li>
                                </ul>
