...
<html lang="fr">
  <head>
	...
	<title>Fiduciaire Tax Manager | Revenus locatifs</title>
				...
				<div class="col-md-9">
				  <ul class="ec-user-section">
					...
					<li>
					  ...
					  <div class="lang">
						<a href="en/rental-income.php">English</a>
						<a href="revenus-locatifs.php" class="active">French</a>
					  </div>
					</li>
		  ...
		  <div class="tax-main-section">
			<div class="container">
			  <div class="row">
				...
				<div class="col-md-8">
				  <div class="fancy-title left-align"><h1>Revenus locatifs</h1></div>
				  <div class="services-wrap">
					<p>Pour les personnes résidant et propriétaires de biens immobiliers en Suisse, les revenus locatifs sont déclarés dans leur propre déclaration d’impôt.</p>
					<p>En ce qui concerne les personnes détenant un bien immobilier en Suisse résidant à l’étranger et selon la loi et les pratiques cantonales suisses, les titulaires d’un bien immobilier sont assujettis aux revenus locatifs. Cela veut dire qu’ils doivent payer l’impôt sur les revenus locatifs perçus. </p>
					<p>Les cantons prennent en compte un forfait comme revenu locatif même si le bien immobilier n’a pas été loué ou considéré comme résidence secondaire.</p>
