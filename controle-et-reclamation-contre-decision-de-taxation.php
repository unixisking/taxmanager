...
<html lang="fr">
  <head>
    ...
    <title>Fiduciaire Tax Manager | Décision de taxation </title>
	<meta name="description" content="Lorsque vous recevez une décision de taxation, vous disposez de 30 jours pour déposer une réclamation, pour ce faire, nous vous conseillons de faire appel à un cabinet professionnel tel que notre fiduciaire."/>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Contrôle et réclamation contre décision de taxation </h1></div>
                            <div class="services-wrap">
                                <p>Une décision de taxation n’est pas définitive, le contribuable ou son mandataire à le droit de s’opposer à la décision par écris sous un délai de 30 jours à compter de la notification de la décision.</p>
                                <p>Dans certain cas et selon la décision du taxateur, la réclamation est indispensable, nous conseillons nos lecteurs de faire appel à une étude tel que nous afin de faire valoir vos droits.</p>
