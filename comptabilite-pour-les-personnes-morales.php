...
<html lang="fr">
  <head>
    ...
    <title>Fiduciaire Tax Manager | Comptabilité pour les personnes morales</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Comptabilité pour les personnes morales</h1></div>
                            <div class="services-wrap">
                                <p>Selon le code des obligations, toutes les personnes morales tel que les sociétés à responsabilités limités, les sociétés anonymes, les coopératives, les associations et fondations ont l’obligation de tenir une comptabilité complète comprenant un bilan, journal des opérations et compte résultat.</p>
