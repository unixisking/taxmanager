...
<html lang="fr">
  <head>
    ...
    <title>Fiduciaire Tax Manager | Gestion des salaires</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>gestion des salaires</h1></div>
                            <p>La gestion des salaires au sein d’une entreprise n’est pas une tâche facile, particulièrement le calcul du salaire horaire, mensuel, 13em, indemnités journalières maladies et accident, calcul des heures supplémentaires… Cette tache pourrait s'avérer extrêmement compliquée si vous n'utilisez pas le bon outil. Pour cette raison, notre fiduciaire a tout mis en œuvre pour développer un logiciel salaire afin d’offrir à ses clientes entreprises la meilleure solution disponible sur le marché suisse basé uniquement sur le cloud. Nous avons combiné toute l'expérience précédemment acquise par nos employés en matière de gestion des salaires afin que vous puissiez facilement résoudre des situations complexes en un temps-record.</p>
