...
<html lang="en">
  <head>
    ...
    <title>Tax Manager | Success Message</title>
                ...
                <div class="container">
                    <div class="row">
                       ...
                       <?php $_SESSION['fail']='';  }
                        ...
                        ?>
                               <!--  <p>Nous avons bien reçu votre demande et vous contacterons le plus rapidement possible.</p> -->
                                <a href="https://www.taxmanager.ch/" class="submit">Go back to the website</a>
                            </div>
                        </div>
                    </div>
                </div>
