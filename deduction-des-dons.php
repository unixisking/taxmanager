...
<html lang="en">
  <head>
    ...
    <title>Tax Manager | Déduction des dons</title>
            ...
            <div class="tax-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="fancy-title left-align"><h1>Déduction des dons</h1></div>
                            <div class="services-wrap">
                                <p>Vous pouvez en règle générale réclamer la déduction à hauteur de 20% du revenu net imposable si le don a été fait pour une personne morale exonérer d’impôt en raison de son but de service ou utilité publique, nous vous informons que les dons à des personnes morales exonérées d’impôt à des fins culturelles ne sont pas déductibles.</p>
